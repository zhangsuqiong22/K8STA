...
func (in *TestCaseScope) DeepCopyInto(out *TestCaseScope) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TestCaseScope.
func (in *TestCaseScope) DeepCopy() *TestCaseScope {
	if in == nil {
		return nil
	}
	out := new(TestCaseScope)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TesterSpec) DeepCopyInto(out *TesterSpec) {
	*out = *in
	out.TestPodSpec = in.TestPodSpec
	out.TestCaseScope = in.TestCaseScope
}
